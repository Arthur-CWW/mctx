...
flags.DEFINE_string("output_file", "/tmp/search_tree.png", "The output file for the visualization.")
...
def _make_batched_env_model(
    ...
    *,
    ...
    chex.assert_equal_shape([transition_matrix, rewards, discounts, prior_logits])
