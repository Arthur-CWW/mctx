...
def qtransform_by_parent_and_siblings(
    ...
    *,
    ...
    normalized = (completed_by_min - min_value) / (jnp.maximum(max_value - min_value, epsilon))
...
def qtransform_completed_by_mix_value(
    ...
    *,
    ...
    if use_mixed_value:
        ...
        value = raw_value
    completed_qvalues = _complete_qvalues(qvalues, visit_counts=visit_counts, value=value)
